...
const STUDENTS_DATA = [
  { firstName: "An", lastName:"Jonh", batch: 1, age: 20 },
  { firstName: "Bình", lastName:"Jack", batch: 1, age: 22 },
  { firstName: "Cẩm", lastName:"Jonhson", batch: 2, age: 21 },
  { firstName: "An", lastName:"Jam", batch: 2, age: 19 }, // Duplicate first name !
];
...
function updateStudentAge(firstName, lastName, batch, newAge) {
  let student = STUDENTS_DATA.find( value => value.firstName === firstName &&
